...
export default function TileCard({ tile, onSelect, index = 0 }) {
  return (
    <motion.div
      ...
      className="group relative rounded-[24px] bg-white border border-black/8 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-[#C8102E]/50 shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.12),0_0_25px_rgba(200,16,46,0.15)] flex flex-col justify-between"
    >
      {/* Top Image Container */}
      <div className="relative w-full aspect-[4/3] overflow-hidden bg-neutral-100">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#0B0B0B]/70 via-[#0B0B0B]/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-400 flex items-center justify-center p-6 z-20">
          <button
            ...
            className="px-6 py-3 rounded-full bg-white text-black font-semibold text-xs tracking-widest uppercase shadow-xl hover:bg-[#C8102E] hover:text-white transition-all duration-300 flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0"
          >
      ...
      <div className="p-6 flex-1 flex flex-col justify-between bg-white">
        <div>
          ...
          <h3 className="text-xl font-light text-[#0B0B0B] font-display leading-tight mb-3 group-hover:text-[#C8102E] transition-colors"
        ...
        <div className="pt-4 border-t border-black/8 flex items-center justify-between">
          ...
          <button
            onClick={() => onSelect(tile)}
            className="inline-flex items-center gap-1 text-[11px] font-semibold tracking-wider text-neutral-800 hover:text-[#C8102E] transition-colors group/btn"
          >
            Details
